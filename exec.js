...
if (process.argv.length <= 2) {
    console.log(colors__WEBPACK_IMPORTED_MODULE_0__["default"].red("Missing argument: No command provided: Valid commands are [serveWithProxy] and [startProxyServer]"));
    process.exit(1);
}
